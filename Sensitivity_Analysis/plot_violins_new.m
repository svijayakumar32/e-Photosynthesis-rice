...
%print(gcf,fullfile('Outputs/rice_params/graphs',"violin_enzymes_Stress2.pdf"),'-dpdf','-bestfit');
%print(gcf,fullfile('Outputs/rice_params/graphs',"violin_enzymes_Stress2.png"),'-dpng')
...
% Save and print the plot
set(gcf, 'PaperOrientation', 'landscape');
%print(gcf,fullfile('Outputs/rice_params/graphs',"violin_enzymes_Current2.pdf"),'-dpdf','-bestfit');
%print(gcf,fullfile('Outputs/rice_params/graphs',"violin_enzymes_Current2.png"),'-dpng');
...
% Save and print the plot
set(gcf, 'PaperOrientation', 'landscape');
%print(gcf,fullfile('Outputs/rice_params/graphs',"violin_enzymes_Future2.pdf"),'-dpdf','-bestfit');
%print(gcf,fullfile('Outputs/rice_params/graphs',"violin_enzymes_Future2.png"),'-dpng')
