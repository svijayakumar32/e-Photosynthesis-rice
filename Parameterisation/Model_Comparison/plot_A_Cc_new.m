...
load('Farq_ePhoto_results_new.mat') % Result of running Farq_ePhoto_comparison_new but with new alpha values
figure
...
% Plot Cc (x) against Gross Assimilation (y) for aRubisco = 1.36, aEnzymes = 1.12  (red dashed lines)
...
set(gcf, 'PaperUnits', 'inches', ...
         'PaperSize', [25 20], ...
         'PaperPosition', [0 0 25 20], ...
         'PaperOrientation', 'landscape');
%savefig('Cc_vs_Farq_ePhoto.fig');
%print(gcf,fullfile('Outputs/rice_params/graphs',"Cc_vs_Farq_ePhoto_new2"),'-dpdf','-r300');
exportgraphics(gcf, fullfile('Outputs/rice_params/graphs', "Cc_vs_Farq_ePhoto_new2.pdf"), 'ContentType', 'vector', 'Resolution', 300, 'ColorSpace', 'rgb');
