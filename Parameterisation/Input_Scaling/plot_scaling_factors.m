...
set(gca, 'FontSize', 16);
xlabel('α_{Enzymes}','FontSize', 16)
ylabel('SSR','FontSize', 16)
hold off
% Export figure
set(gcf, 'PaperOrientation', 'landscape');
print(gcf,fullfile('Outputs/rice_params/graphs',"Scaling_Factor_Optimization_for_RuBP_regeneration_new2"),'-dpdf','-bestfit');
...
set(gca, 'xtick', 0.5:0.2:1.5);
set(gca, 'FontSize', 16);
xlabel('α_{Rubisco}','FontSize', 16)
ylabel('SSR','FontSize', 16)
hold off
% Export figure
set(gcf, 'PaperOrientation', 'landscape');
print(gcf,fullfile('Outputs/rice_params/graphs',"Scaling_Factor_Optimization_for_Rubisco_carboxylation_new2"),'-dpdf','-bestfit');
