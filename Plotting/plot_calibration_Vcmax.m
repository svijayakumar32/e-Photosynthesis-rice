...
%% Load Vcmax data 
load('Vcmax_simple_3_result.mat');

% Create figure
figure;
hold on;

% % Re-specify Cc and Gross Assimilation data for FvCB model
...
% Set the x-axis limits from 0 to 300
xlim([0 200]);

% Add labels, title, and legend
xlabel('C_c');
ylabel('Gross Assimilation');
title('Scaling Factors for Rubisco');
...
print(gcf,fullfile('Outputs/rice_params/graphs',"Scaling_Factors_for_Rubisco"),'-dpdf','-fillpage');
